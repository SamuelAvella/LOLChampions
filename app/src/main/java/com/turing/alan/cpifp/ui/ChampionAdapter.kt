...
import com.turing.alan.cpifp.ui.ChampionListFragment

class ChampionAdapter(private val toChampionDetail:((Champion)->Unit)) : ListAdapter<Champion, ChampionAdapter.ChampionViewHolder>(ChampionDiffCallback) {
